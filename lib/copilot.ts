...
const A_BILL: Localized = {
  ...
  th: {
    ...
    bullets: [
      ...
      "PeakShield AI ช่วยเลี่ยงได้ ~฿180K ด้ว·ารหน่วงเวลาเปิด Air Comp #2 ไป 15 นาที + พรีคูลช่วง off-peak",
...
const FALLBACK: Record<Locale, { title: string; body: string }> = {
  ...
  th: {
    ...
    body: "ผมเชื่อมกับข้อมูลเรียลไทม์ของโรงงาน — พลังงาน สินทรัพย์ การผลิต และคาร์บอน ลองถามคำถามแนะนำ หรือถามถึงเครื่องจักร สา·ารผลิต หรือ KPI ที่ต้องการได้เลย",
  },
  ja: {
    title: "私が確認できること",
